...
Class UsersAD
    ...
    Private Sub AdminsUsers_SelectedCellsChanged(sender As Object, e As SelectedCellsChangedEventArgs) Handles AdminsUsers.SelectedCellsChanged
        Dim selectRow As DataRowView
        selectRow = AdminsUsers.SelectedItem
    ...
    Private Sub UsersAD_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        Usuarios()
    End Sub
    ...
    Private Sub Usuarios()
        Try
            conexion.Open()
            consulta = "SELECT idusuario, user, pass, docnom, apnom, tel1, tel2, tel3 FROM usuarios WHERE tipo_usuario='Administrador'"
            comando = New MySqlCommand(consulta, conexion)
            adaptador = New MySqlDataAdapter(comando)
            adaptador.Fill(tabla)
            AdminsUsers.ItemsSource = tabla.DefaultView

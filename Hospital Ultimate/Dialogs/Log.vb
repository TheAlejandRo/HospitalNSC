...
Public Class Log
    ...
    Private Shared Sub add(ByVal eTipo As TipoMensaje, ByVal sMensaje As String, Optional ByVal objTraza As StackFrame = Nothing)
    ...
    Private Shared Function getFileFecha() As String
        ...
        Dim path As String = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "/Hospital Log/"
    ...
    Public Shared Sub e(sMensaje As String, objExcepcion As Exception, Optional ByVal objTraza As StackFrame = Nothing)
        add(TipoMensaje.LERROR, sMensaje & vbNewLine &
            vbTab & objExcepcion.Message & vbNewLine &
            vbTab & objExcepcion.ToString, objTraza)
    End Sub

    Public Shared Sub e(sMensaje As String, Optional ByVal objTraza As StackFrame = Nothing)
        add(TipoMensaje.LERROR, sMensaje, objTraza)
    End Sub

    Public Shared Sub w(sMensaje As String, Optional ByVal objTraza As StackFrame = Nothing)
        add(TipoMensaje.WARNING, sMensaje, objTraza)
    End Sub

    Public Shared Sub i(sMensaje As String, Optional ByVal objTraza As StackFrame = Nothing)
        add(TipoMensaje.INFO, sMensaje, objTraza)
    End Sub

    Public Shared Sub d(sMensaje As String, Optional ByVal objTraza As StackFrame = Nothing)

...
Public Class Drpanel3
    ...
    Public Sub Lista()
        Try
            conexion.Open()
            consulta = "SELECT Tiket FROM pacientes WHERE idDoctor='8' AND estado_paciente IN ('0', '1')"
    ...
    Private Sub cliente_sig_Click(sender As Object, e As RoutedEventArgs) Handles cliente_sig.Click
        If list_pacientes.SelectedIndex <> -1 Then
            Try
                ...
                estadopac = "UPDATE pacientes SET estado_paciente='1', CallSpeak='1' WHERE tiket='" & paciente.Text & "' AND idDoctor='8'"
    ...
    Private Sub Complete_Click(sender As Object, e As RoutedEventArgs) Handles Complete.Click
        Try
            ...
            estadopaciente = "UPDATE pacientes SET estado_paciente='2' WHERE tiket='" & paciente.Text & "'  AND idDoctor='8'"
